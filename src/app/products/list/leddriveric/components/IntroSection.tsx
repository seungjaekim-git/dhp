...
export default function IntroSection({
  title = "LED 드라이버 IC",
  description = "LED 드라이버 IC는 LED 조명의 효율적이고 안정적인 작동을 위한 핵심 반도체 부품입니다. 다양한 입력 전압과 출력 전류 범위, 디밍 방식, 토폴로지 옵션을 갖춘 제품들을 카테고리, 제조사, 사양별로 찾아보세요.",
  breadcrumb = [
    { label: "홈", href: "/" },
  ...
  badges = [
    { text: "고효율", bgColor: "bg-blue-100/80", textColor: "text-blue-800" },
    { text: "저전력", bgColor: "bg-green-100/80", textColor: "text-green-800" },
    { text: "다양한 패키지", bgColor: "bg-purple-100/80", textColor: "text-purple-800" },
    { text: "안정적 성능", bgColor: "bg-amber-100/80", textColor: "text-amber-800" }
  ]
}: IntroSectionProps) {
  return (
        ...
        >
          ...
          >
            ...
            <p className="text-lg max-w-3xl text-gray-400">
              최고의 LED 드라이버 IC를 선택하여 최적의 제품을 설계하세요.
            </p>
          </motion.div>
