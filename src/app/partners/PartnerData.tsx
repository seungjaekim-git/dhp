...
export const PARTNER_DATA: PartnerData[] = [
  {
    ...
    sales_markets: "중국 선전 (지사), 대한민국 서울 (지사)",
    images: {
  ...
  },
  {
    ...
    business_type: "Exporter, Importer, Manufacturer, ODM, OEM",
    ...
    email: "inquiry@zowie.com.tw",
    phone: "+886-2-2219-5533",
    fax: "+886-2-2219-1133",
  ...
  },
  {
    ...
    business_type: "제조업, 유통업, 온라인판매, 대리점, 컨설팅, 도매업, 수출업",
  ...
  },
  {
    ...
    business_type: "전자 및 광학 부품과 장비의 개발, 제조, 무역",
  ...
  },
  {
    ...
    email: "sales@xlsemi.com",
    phone: "+86 (21) 3382-2315",
    fax: "+86 (21) 3382-2313",
  ...
  },
  {
    ...
    email: "wangyan1519@powtech.crmicro.com",
    phone: "+86-21-60738989 내선 341",
    fax: "+86-510-85872470",
  ...
  },
  {
    ...
    email: "weiting@linpotek.com.tw",
    phone: "+886-2-8797-1297",
    fax: "+886-2-8797-1570",
 ...
 
  {
    ...
    business_type: "제조업체, 수출업체",
    main_products: "보드 투 보드 커넥터: 핀 헤더, 여성 헤더, 점퍼, DIN 41612, LCM 등보드 투 와이어 커넥터: 웨이퍼, 하우징, 터미널, 와이어 투 와이어 등리본 케이블 커넥터: 시리얼 ATA 커넥터, IDC 소켓, IDC 플러그, IDC 헤더, 박스 헤더, 래치 헤더, 이젝션 헤더, 카드 엣지 커넥터 등FPC/FFC 소켓 및 케이블: ZIF 또는 비 ZIF 타입IC/메모리 카드 커넥터: PCMCIA, 컴팩트 플래시, SD 카드, 메모리 스틱, XD 카드, 스마트 카드, SIM 카드, 게임 카트리지, 엣지 슬롯, AGP 슬롯, PCI 슬롯 등소켓형 커넥터: 배터리 홀더, DIMM 소켓, SIMM 소켓, SOJ 소켓, PLCC 소켓, IC 소켓 등직사각형 I/O 커넥터: USB, 미니 USB, D-sub, 고밀도, 하프 피치, SCA, SCSI, 1394, 1394a, 1394b, V.35, 휴대폰 커넥터 등원형 I/O 커넥터: 잭 및 플러그, DC, 이어폰, RCA, 원형 DIN, 미니 DIN, 동축 커넥터 등통신 I/O 커넥터: RJ11, RJ12, RJ45, 모듈러 잭 및 플러그, 전화 스플라이스 등터미널 및 터미널 블록: 배리어 타입, 유로 PCB 타입, 플러그인, IDC-클램프, 스크류-클램프, 케이지-클램프, 스프링-클램프, 스크류리스, 자동차용 터미널 및 하우징 등맞춤형 커넥터 및 케이블 어셈블리: 고객의 요구에 따른 커넥터 및 케이블 어셈블리 제작",
    ...
    email: "mta@morethanall.com",
    phone: "886-2-29082428",
    fax: "886-2-29082429",
